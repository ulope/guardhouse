...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Account.owner'
        db.alter_column('main_account', 'owner_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['auth.User']))

        # Adding unique constraint on 'Account', fields ['owner']
        db.create_unique('main_account', ['owner_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Account', fields ['owner']
        db.delete_unique('main_account', ['owner_id'])

        # Changing field 'Account.owner'
        db.alter_column('main_account', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
