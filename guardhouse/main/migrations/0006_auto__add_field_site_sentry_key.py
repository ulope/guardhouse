...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Site.sentry_key'
        db.add_column('main_site', 'sentry_key', self.gf('django.db.models.fields.CharField')(default='XX', max_length=50, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Site.sentry_key'
        db.delete_column('main_site', 'sentry_key')
