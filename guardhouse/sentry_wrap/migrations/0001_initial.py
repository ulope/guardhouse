...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('sentry_wrap_sitemessage', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(related_name='grouped_messages', to=orm['main.Site'])),
            ('message', self.gf('django.db.models.fields.related.ForeignKey')(related_name='site', to=orm['sentry.GroupedMessage'])),
        ))
        db.send_create_signal('sentry_wrap', ['SiteMessage'])


    def backwards(self, orm):
        
        # Deleting model 'SiteMessage'
        db.delete_table('sentry_wrap_sitemessage')
    ...
    models = {
        ...
        'sentry_wrap.sitemessage': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'message': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'site'", 'to': "orm['sentry.GroupedMessage']"}),
            'site': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'grouped_messages'", 'to': "orm['main.Site']"})
        }
    }
